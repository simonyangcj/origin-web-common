...
"associated with the project": "关联项目",
"Bindings can be created later from within a project.": "从项目中创建Bindings。",
"Bindings create a secret containing the necessary information for an application to use a service.": "Bindings创建一个有应用使用service必要信息的secret。",
"Bindings create a secret containing the necessary information for an application to use this service.": "Bindings创建一个有应用使用该service必要信息的secret。",
Cancel: "取消",
...
Save: "保存",
"Secrets can be referenced later from an application.": "密钥以后可以从应用中引用。",
"See All": "保存所有",
...
"The binding secret will only be available to new pods. You will need to redeploy your application.": "绑定secret只能用于新pods，你需要重新部署应用。",
"There are no applications in this project": "此项目中没有应用",
"There are no bindable services in this project": "项目中没有可绑定的服务",
