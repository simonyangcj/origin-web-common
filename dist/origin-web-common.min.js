...
controller: [ "$filter", "gettextCatalog", function(e, t) {
var n = this;
n.uiSelectMatchPlaceholder = this.applications.length ? t.getString("Select an application") : t.getString("There are no applications in this project");
var r = e("humanizeKind");
n.groupByKind = function(e) {
return r(e.kind);
};
} ]
...
controller: [ "$scope", "$location", "ProjectsService", "NotificationsService", "displayNameFilter", "Logger", "gettextCatalog", function(t, n, r, o, i, a, s) {
t.submitButtonLabel || (t.submitButtonLabel = s.getString("Create")), t.isDialog = "true" === t.isDialog;
...
type: "success",
message: s.getString("Project {{name}} was successfully created.", {
name: i(e)
})
});
}, function(n) {
...
var i = r.message || s.getString("An error occurred creating project {{displayName}}.", {
displayName: e
});
o.addNotification({
type: "error",
message: i
}), a.error(s.getString("Project {{displayName}} could not be created.", {
displayName: e
}), n);
}
});
...
} ]), angular.module("openshiftCommonUI").directive("deleteProject", [ "$uibModal", "$location", "$filter", "$q", "hashSizeFilter", "APIService", "NotificationsService", "ProjectsService", "Logger", "gettextCatalog", function(e, t, n, r, o, i, a, s, c, l) {
return {
restrict: "E",
scope: {
project: "=",
...
replace: !0,
link: function(r, o, i) {
var u = n("displayName"), d = function() {
...
var e = "Project '" + u(r.project) + "'";
s.delete(r.project).then(function() {
a.addNotification({
type: "success",
message: e + l.getString(" was marked for deletion.")
}), r.success && r.success(), d();
}).catch(function(t) {
a.addNotification({
type: "error",
message: e + l.getString(" could not be deleted."),
details: n("getErrorDetails")(t)
}), c.error(e + l.getString(" could not be deleted."), t);
});
});
};
}
...
controller: [ "$scope", "$filter", "$location", "Logger", "NotificationsService", "ProjectsService", "annotationNameFilter", "displayNameFilter", "gettextCatalog", function(t, n, r, o, i, a, s, c, l) {
t.submitButtonLabel || (t.submitButtonLabel = l.getString("Save")), t.isDialog = "true" === t.isDialog;
var u = n("annotation"), d = n("annotationName"), p = function(e) {
return {
...
return n.metadata.annotations[d("description")] = t.description, n.metadata.annotations[d("displayName")] = t.displayName, n;
}, g = function(e) {
...
t.editableFields = p(t.project), t.update = function() {
t.disableInputs = !0, t.editProjectForm.$valid && a.update(t.project.metadata.name, g(f(t.project, t.editableFields))).then(function(e) {
var n = t.redirectAction();
n && n(encodeURIComponent(t.project.metadata.name)), i.addNotification({
type: "success",
message: l.getString("Project {{name}} was successfully updated.", {
name: c(e)
})
});
}, function(e) {
t.disableInputs = !1, t.editableFields = p(t.project), i.addNotification({
type: "error",
message: l.getString("An error occurred while updating project {{displayName}}.", {
displayName: c(t.project)
}),
details: n("getErrorDetails")(e)
}), o.error(l.getString("Project {{displayName}} could not be updated.", {
displayName: c(t.project)
}), e);
});
...
"An error occurred creating project {{displayName}}.": "创建项目{{displayName}}时发出现错误。",
"An error occurred creating the binding.": "创建绑定出现错误。",
"An error occurred while updating project {{displayName}}.": "更新项目{{displayName}}出现错误。",
"and the action": "关联的资源并且",
"Are you sure you want to delete the project": "确定删除项目",
"associated with the project": "与项目",
"Bindings can be created later from within a project.": "从项目中创建Bindings。",
"Bindings create a secret containing the necessary information for an application to use a service.": "Bindings创建一个secret，其中包含一个应用使用service时需要的必要信息。",
"Bindings create a secret containing the necessary information for an application to use this service.": "Bindings创建一个secret，其中包含一个应用使用service时需要的必要信息。",
Cancel: "取消",
...
Create: "创建",
"Create a binding for": "创建绑定",
"Create a binding for application": "给应用创建绑定",
"Create a secret in": "创建密钥在",
Delete: "删除",
"delete all resources": "删除所有",
"Delete Project": "删除项目",
Description: "描述",
"Display Name": "显示名称",
"Do not bind at this time.": "此时不绑定。",
Error: "错误",
"has been bound to": "被绑定到",
"has been created successfully.": "被创建成功。",
Info: "信息",
"Its data will be available to your application as environment variables.": "数据可以作为你应用的环境变量。",
"Make sure this is something you really want to do!": "确认当前操作！",
"My Project": "我的项目",
"my-project": "我的-项目",
Name: "名称",
"Name is required.": "名称是必选项。",
"Name must have at least two characters.": "名称最少两个字符。",
Pending: "加载中",
"Please type": "请输入",
"Project {{displayName}} could not be created.": "项目{{name}}创建失败。",
"Project {{displayName}} could not be updated.": "项目{{displayName}}更新失败。",
"Project {{name}} was successfully created.": "项目{{name}}创建成功。",
"Project {{name}} was successfully updated.": "项目{{name}}更新成功。",
"Project names may only contain lower-case letters, numbers, and dashes.\n          They may not start or end with a dash.": "项目名称可能只包含小写字母，数字，下横线。\n没有以下横线开始或结束。",
"project to delete": "删除项目",
Save: "保存",
"Secrets can be referenced later from an application.": "密钥后续可以在应用中被引用。",
"See All": "保存所有",
"Select a service:": "选择一个service:",
"Select an application": "选择一个应用",
Success: "成功",
"successfully.": "成功。",
"that you may need to reference in your application.": "你需要在应用中引用。",
"The binding": "绑定",
"The binding could not be created.": "无法创建绑定。",
"The binding is being created.": "正在创建绑定。",
"The binding operation created the secret": "绑定操作创建密钥",
"The binding secret will only be available to new pods. You will need to redeploy your application.": "绑定的secret只能用于新pods，你需要重新部署应用。",
"There are no applications in this project": "此项目中没有应用",
"There are no bindable services in this project": "项目中没有可绑定的services",
"This may take several minutes.": "可能需要几分钟。",
"This name is already in use. Please choose a different name.": "名称已经被使用，请选择其他名称。",
"This service is not yet ready. If you bind to it, then the binding will be pending until the service is ready.": "service不存在，如果绑定，binding将会被加载至service完成。",
"This will": "这将",
"to be used later": "项目中，供以后使用",
